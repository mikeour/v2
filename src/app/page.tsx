...
export default function Home() {
  return (
    <main className="prose mx-auto w-full max-w-[952px] prose-p:my-[0.8em] prose-a:text-blue-400">
        ...
        {externalLinks.map((externalLink) => {
          return (
            <a
              ...
              className="flex aspect-square w-11 shrink-0 items-center justify-center rounded bg-gray-800 p-3 transition-colors group-hover:bg-gray-700 group-hover:text-blue-400"
            >
