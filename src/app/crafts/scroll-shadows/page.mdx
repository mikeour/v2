...
Ultimately our goal is to create a reusable component that will be as easy to use as:
...
Knowing what our intended API looks like, let's get started by using our `useScrollShadows` hook that we created and connecting it to an overflowing element:
