...
import * as BasicDemo from "./demos/basic/demo";
...
<Demo
  ...
  controls={[{ type: "slider", name: "duration", label: "Duration", min: 0, max: 1000, step: 50, defaultValue: 300, unit: "ms" }]}
/>
...
<Demo
  demo={BasicDemo}
  caption="A minimal implementation with CSS transitions."
  path="app/crafts/animated-tabs/demos/basic"
/>
